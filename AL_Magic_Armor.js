...
Effect:	This script adds the flavored versions of standard magic armor and shields found in AL adventures to the MPMB sheet. They will all be listed as AL [categories] in the Magic Item selection, with further choices as needed. Helms can be found in the AL Magic Items script as most do not provide AC. The AL Armor (Common) category includes both common armor and shields despite the name.
...
This is not a complete list since I do not have every published adventure, but it's a start. If you do not see an item listed from a season marked complete, it should be because there was no flavor.*/
	...
	//Complete: S0-S10, Guild Adept, DC-POA, CCCs, official DRW, RMH, 
...
MagicItemsList["al armor +1, +2, +3"] = {
	...
	"+1 half plate: thurûmkhar (fr-dc-fet-1)" : {
		name : "Thurûmkhar, +1 Half Plate (FR-DC-FET-1)",
		source : [["AL", "FR-DC"]],
		rarity : "rare",
		allowDuplicates : true,
...
MagicItemsList["al armor (common)"] = {
	...
	"cast-off breastplate: gilded jeer (fr-dc-aku-1)" : {
		name : "Gilded Jeer, Cast-Off Breastplate (AKU-1)",
		source : [["AL", "FR-DC"]],
		type : "armor (medium)",
		description : "This stage-worn ceremonial breastplate has a lacquered sheen of obsidian & sorrow. It was part of a tragic operatic production. When struck in battle, the armor sings with the spirit of past audiences. A well-placed blow draws ghostly applause, echoing through the air in phantom claps. A missed strike elicits spectral jeering: disappointed, yet still watching. I can doff it as a Magic action.",
		descriptionLong : "This stage-worn ceremonial breastplate has a lacquered sheen of obsidian and sorrow. It was part of a tragic operatic production. When struck in battle, the armor sings with the spirit of the audience it once enthralled. A well-placed blow draws ghostly applause, echoing through the air in phantom claps. A missed strike elicits spectral jeering from an invisible crowd: disappointed, yet still watching. I can doff it as a Magic action.",
		descriptionFull : "This stage-worn ceremonial breastplate has a lacquered sheen of obsidian and sorrow, and was once part of a tragic operatic production. When struck in battle, the armor sings with the spirit of the audience it once enthralled. A well-placed blow draws ghostly applause, echoing through the air in phantom claps. A missed strike elicits spectral jeering from an invisible crowd—disappointed, yet still watching.\n   You can doff this armor as a Magic action.",
		armorAdd : { select : "Cast-Off Breastplate", options : ["Cast-Off Breastplate"] },
		action : [["action", "Cast-Off Breastplate"]]
	},
	...
	"cast-off plate: sorcerous paladin of love and justice costume (fr-dc-rpsg-10)" : {
		name : "Sorcerous Paladin of Love & Justice Costume (Cast-Off Plate)",
		source : [["AL", "FR-DC"]],
		type : "armor (heavy)",
		description : "This suit of gaudy white plate has a frilly red surcoat, pleated blue skirt, & trailing yellow ribbons on its vambraces. Striking a dramatic pose while proclaiming: \"In the name of Selûne, I will punish you!\" causes the armor to shimmer & sparkle with rainbow hues, shedding 10-ft bright light & 10-ft dim. Winking & saying: \"Kira kira~!\" stops the light. Both are bonus actions. The armor can be doffed as a Magic action by doing a pirouette & shouting: \"Love and justice triumphs once again!\"",
		descriptionLong : "This suit of gaudy white plate has a frilly red surcoat, a pleated blue skirt, and trailing yellow ribbons on its vambraces. Striking and holding a dramatic pose while confidently proclaiming to all and sundry: \"In the name of Selûne, I will punish you!\" causes the armor to shimmer and sparkle with rainbow hues, shedding 10-ft bright light and 10-ft dim. Winking and saying: \"Kira kira~!\" stops the light. Both are bonus actions. The armor can be doffed as a Magic action by doing a pirouette and shouting the words: \"Love and justice triumphs once again!\"",
		descriptionFull : "This suit of gaudy white plate armor comes replete with a frilly red surcoat, a pleated blue skirt, and trailing yellow ribbons on its vambraces. Striking and holding a dramatic pose while confidently proclaiming to all and sundry: “In the name of Selûne, I will punish you!” causes the armor to shimmer and sparkle with rainbow hues, while winking and saying the words: “Kira kira~!” extinguishes the light. The armor can be doffed by doing a pirouette and shouting the words: “Love and justice triumphs once again!”\n   " + toUni("Beacon") + ". You can take a Bonus Action to cause the item to shed Bright Light in a 10-foot radius and Dim Light for an additional 10 feet, or to extinguish the light.\n   You can doff this armor as a Magic action.",
		armorAdd : { select : "Cast-Off Plate", options : ["Cast-Off Plate"] },
		action : [["action", "Cast-Off Plate"]]
	},
	"cast-off plate: bluesteel (fr-dc-thay-4)" : {
	...
	"shield of expression: do'urden (fr-dc-scrog-2)" : {
	...
	"breastplate of gleaming: froghemoth hide (ps-dc-tt-202)" : {
		name : "Froghemoth Hide (Gleaming Breastplate, TT-202)",
		source : [["AL", "PS-DC"]],
		type : "armor (medium)",
		description : "Made with thick rubbery hide of Froghemoth, this breastplate keeps me unharmed by extreme temps under 0\u00B0F and over 100\u00B0F. It also never gets dirty.",
		descriptionFull : "Made with thick rubbery hide of Froghemoth, this armor has the minor property Temperate.\n   " + toUni("Temperate") + ". You are unharmed by temperatures of 0 degrees Fahrenheit or lower, and 100 degrees Fahrenheit or higher.\n   This armor never gets dirty.",
		armorAdd : { select : "Breastplate of Gleaming", options : ["Breastplate of Gleaming"] },
		savetxt : { immune : ["temps past 0\u00B0F/100\u00B0F"] },
	},
...
MagicItemsList["al armor (other)"] = {
	...
	"glamoured studded leather: phantom's raiment (fr-dc-aku-1)" : {
		name : "Phantom's Raiment (Glamoured Studded Lthr, AKU-1)",
		source : [["AL", "FR-DC"]],
		type : "armor (studded leather)",
		rarity : "rare",
...
MagicItemsList["al shields"] = {
	...
	"battering shield (bmg-drw-od-2)" : {
		...
		attunement : true,
		defaultExcluded : true,
		description : "The convex surface of this shield is smooth and shiny ebon black with fine flecks of white that sparkle when exposed to moonlight. It gives an extra +1 to AC and has 3 charges, regaining 1d3 at dawn. When I'm holding the shield and push a creature 5 ft away, I can spend 1 charge to push that creature an additional 10 ft, knock it prone, or both.[Banned see full description]",
		descriptionFull : "The convex surface of this shield is a smooth and shiny ebon black. Though plain, it has fine flecks of white that sparkle when exposed to moonlight.\n   While holding this iron tower shield, you gain a +1 bonus to AC. This bonus is in addition to the shield's normal bonus to AC.\n   Additionally, the shield has 3 charges, and it regains 1d3 expended charges daily at dawn. If you are holding the shield and push a creature within your reach at least 5 feet away, you can expend 1 charge to push that creature an additional 10 feet, knock it prone, or both.[CR items should never have been allowed per ALPG 15.3, best replacement is probably a Shield +2 per guidance]",
